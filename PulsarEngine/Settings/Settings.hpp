...
enum MenuSettings2 {
    SETTINGMENU_RADIO_BLUR = 0,
    SETTINGMENU_RADIO_FPS = 1
};
...
enum MenuSettingTimes {
    MENUSETTING_TIMES_DISABLED = 0x0,
    MENUSETTING_TIMES_ENABLED = 0x1
};
...
enum HostSettingFeather {
    HOSTSETTING_FEATHER_ENABLED,
    HOSTSETTING_FEATHER_DISABLED
};

enum HostSettingBill {
    HOSTSETTING_BILL_ENABLED,
    HOSTSETTING_BILL_DISABLED
};

enum HostSettingLAND {
    HOSTSETTING_LAND_ENABLED,
    HOSTSETTING_LAND_DISABLED
};
...
//MENU SETTINGS2
enum MenuSettingBlur {
    MENUSETTING_BLUR_DISABLED = 0x0,
    MENUSETTING_BLUR_ENABLED = 0x1
};
