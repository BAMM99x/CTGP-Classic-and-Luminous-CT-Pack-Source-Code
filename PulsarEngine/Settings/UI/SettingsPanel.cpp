...
u8 SettingsPanel::radioButtonCount[SettingsPanel::maxPageCount] ={ 5, 5, 1, 2 }; //menu, race, host
u8 SettingsPanel::scrollerCount[SettingsPanel::maxPageCount] ={ 0, 1, 1, 0 }; //menu, race, host

u8 SettingsPanel::buttonsPerPagePerRow[SettingsPanel::maxPageCount][8] = //first row is SettingsType, 2nd is rowIdx of radio
{
    { 2, 2, 2, 2, 2, 0, 0, 0 }, //Menu 
    { 2, 2, 2, 2, 4, 0, 0, 0 }, //Race
    { 2, 0, 0, 0, 0, 0, 0, 0 }, //Host
    { 2, 2, 0, 0, 0, 0, 0, 0 }, //Menu2
};
