...
void Remove_Background_Blur_Glow(){
    ...
    if(Pulsar::Settings::Mgr::GetSettingValue(Pulsar::Settings::SETTINGSTYPE_MENU2,SETTINGMENU_RADIO_BLUR) == 1){
...
static PageLoadHook RBBG_Hook(Remove_Background_Blur_Glow);
